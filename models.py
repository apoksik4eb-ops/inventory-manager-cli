...
class Product(Base):
    ...
    supplier: Mapped[list["Supplier"]] = relationship(back_populates="product")
...
class Stock_movement(Base):
    ...
    __table_args__ = (
        CheckConstraint("quantity >= 0", name = "check_quntity_not_negative"),
    ...
    product: Mapped[list["Product"]] = relationship(back_populates="stock_movement")